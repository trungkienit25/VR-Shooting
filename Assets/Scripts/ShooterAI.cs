...
public class ShooterAI : EnemyGeneral, ITakeDamage
{
    ...
    public void Shoot()
    {
        ...
        // Initialize the projectile with the weapon (if needed)
        // bullet.Init(weapon); 

        // Align the projectile's rotation with the enemy's forward direction
        bullet.transform.rotation = transform.rotation;
        Rigidbody bulletRigidbody = bullet.GetComponent<Rigidbody>();
        bulletRigidbody.AddForce(transform.forward * shootingForce, ForceMode.Impulse);
        // Call the Launch() method on the projectile
        bullet.Launch();
